...
{{--            </div>--}}
            <table class="table-fixed border-separate border-spacing-0 text-sm">
                ...
                <tr class="">
                    <th class="border px-1 py-3 text-center ">#</th>
                    <th class="border px-1 py-3 text-center ">user name</th>
                    <th class="border px-1 py-3 text-center ">email</th>


                    <th class="border px-1 py-3 text-center">status payment</th>
                    <th class="border px-1 py-3 text-center">status order</th>

                    <th class="border px-1 py-3 text-center">total price</th>
                    <th class="border px-1 py-3 text-center">cart number</th>
...
{{--                    @dd($order->user)--}}
                    <tr class="border-b even:bg-blue-200">
                        <td class="px-1 py-3 text-center">{{$i++}}</td>
                        <td class="px-1 py-3 text-center">{{$order->user->name}}</td>
                        <td class="px-1 py-3 text-center">{{$order->user->email}}</td>
                        <td class="px-1 py-3 text-center">{{$order->status_payment}}</td>



                        <td class="px-1 py-3 text-center">{{$order->status_order}}</td>
                        <td class="px-1 py-3 text-center">{{$order->total_price}}</td>
